...
class KNN:
    ...
    def tune(self, tuning_set, parameters):
    ...
    def update_training_stats(self, prediction, real_class):
    ...
    def update_tuning_stats(self, prediction, parameter, real_class):
        correct = prediction == real_class
        if correct:
    ...
    def update_testing_stats(self, prediction, real_class):
        correct = prediction == real_class
        if correct:
